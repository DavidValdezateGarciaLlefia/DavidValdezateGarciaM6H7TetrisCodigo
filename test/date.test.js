...
import { dias, modificaData, modificaData2, modificaNick } from "../src/js/date.js";

describe('Test de la función orden', () => {
  test('Orden ascendente', () => {
    const partides = [
      { nick: 'Alice', puntos: 50, fecha: '2022-01-01' },
      { nick: 'Bob', puntos: 30, fecha: '2022-01-02' },
    ];

    orden('puntos', 'up', partides);

  
    expect(partides[0].puntos).toBe(30);
    expect(partides[1].puntos).toBe(50);
  });
...
describe('dias', () => {
  it('debería calcular los días transcurridos correctamente', () => {
    ...
    const resultado = dias('05/12/10T21:00:00');
